    ...
    async handleDevice(device){
        ...
        try {
            ...
            if(result!==null) {
                ...
                device.setCapabilityValue("measure_humidity", Math.round(current.humidity * 100,2));
                ...
                device.setCapabilityValue("measure_cloudcover_capability",Math.round(current.cloudCover*100,2));
